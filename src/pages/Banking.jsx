      ...
      <section className="py-[80px] bg-[#ffedf5]">
        ...
        <div className="container mx-auto px-[20px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[30px]">
            {" "}
            {/* Card 1 */}{" "}
            <div className="bg-[#5b1a8c] rounded-[24px] p-[40px_20px] text-center shadow-[0_15px_40px_rgba(0,0,0,0.15)] flex flex-col items-center justify-center transition-transform hover:-translate-y-[5px]">
              {" "}
              ...
              <p className="text-[#fbcfe8] text-[15px] leading-[1.5]">
            ...
            <div className="bg-[#5b1a8c] rounded-[24px] p-[40px_20px] text-center shadow-[0_15px_40px_rgba(0,0,0,0.15)] flex flex-col items-center justify-center transition-transform hover:-translate-y-[5px]">
              ...
              <p className="text-[#fbcfe8] text-[15px] leading-[1.5] break-all">
            ...
            <div className="bg-[#5b1a8c] rounded-[24px] p-[40px_20px] text-center shadow-[0_15px_40px_rgba(0,0,0,0.15)] flex flex-col items-center justify-center transition-transform hover:-translate-y-[5px]">
              ...
              <p className="text-[#fbcfe8] text-[14px] leading-[1.6]">
